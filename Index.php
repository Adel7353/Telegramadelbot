<?php
$Token =  6325118871:AAFPUkXM6o32cPEyxezIu5iHcedg4BTzpME  ; #Your Token
...
bot( sendMessage ,[
 chat_id =>$chat_id, 
 text =>"*انا بوت خاص بالمطور عادل فقط لتجربه الاكواد. *",
...
bot( sendphoto ,[
 chat_id =>$chat_id,
photo =>"https://t.me/nokat_2024",
 caption => *♡* , 
 parse_mode =>"markdown", disable_web_page_preview =>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[[ text => 𝐃𝐄𝐕 adel , url => https://t.me/nokat_2024 ]],
]])]);} 

if($text ==  المطور  || $text ==  عادل  ){ 
bot( sendphoto ,[
 chat_id =>$chat_id,
photo =>"https://t.me/nokat_2024",
 caption =>  اليك المطور عادل🖤🔥. , 
 parse_mode =>"markdown", disable_web_page_preview =>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[[ text => 𝐃𝐄𝐕 Adel  , url => https://t.me/nokat_2024 ]],
